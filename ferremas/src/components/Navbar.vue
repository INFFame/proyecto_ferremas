<template>
    <nav class="navbar navbar-expand-lg bg-custom py-2">
        <div class="container px-4">
            <router-link to="/inicio" class="navbar-brand">
            ...
            <router-link to="/carrito">
                        <button class="btn btn-light btn-custom-nav d-md-block d-lg-none">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-2 fs-5">
                    <li class="nav-item">
                        <router-link to="/" class="nav-link text-white text-center mt-2 mb-1 m-lg-0 my-lg-1">Inicio</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link to="/productos" class="nav-link text-white text-center my-1">Productos</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link to="" class="nav-link text-white text-center my-1">Nosotros</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link to="" class="nav-link text-white text-center my-1">Contacto</router-link>
                    </li>
                    <li class="nav-item" v-if="isLoggedIn && tipoUser.toLowerCase() !== 'cliente'">
                        <router-link to="/bodega" class="nav-link text-white text-center my-1">Bodega</router-link>
                    </li>
                </ul>
                <div>
                <div class="d-flex justify-content-center gap-2 mt-2 mb-4 mt-lg-0 mb-lg-0">
                  <p v-if="isLoggedIn" class="text-white text-center text-capitalize mb-0 me-2 nombre_usuario">Hola,<br>{{ getUsername() }}</p>
                    <router-link to="/carrito">
                        <button class="btn btn-light btn-custom-nav d-none d-lg-block">
                            <i class="bi bi-bag-fill"></i>
                        </button>
                    </router-link>
                    <router-link to="/login">
                        <button class="btn btn-light btn-custom-nav">
                            <i :class="isLoggedIn ? 'bi bi-person-fill-check' : 'bi bi-person-fill'"></i>
                        </button>
                    </router-link>
                    <button v-if="isLoggedIn" @click="logout" class="btn btn-light btn-custom-nav">
...
.bi-bag-fill, .bi-person-fill, 
.bi-person-fill-check, .bi-box-arrow-right {
  font-size: 20px;
  color: #A10828;
}
